...
router.post('/', async function (req, res, next) {
  let { userId, totalAmount, address, phoneNumber, products, isPaid, paymentTransactionRef } =
    req.body;
  try {
...
router.get('/create_payment_url', function (req, res, next) {
  ...
  var returnUrl = `http://${ip.address()}:3000/api/order/vnpay_result`;
  var date = new Date();
...
router.get('/vnpay_result', function (req, res, next) {
